...
class ApiMethod {
    ...
    try {
      ...
      if (data is Map<String, dynamic>) {
        if (data.containsKey('success') && data['success'] == false) {
          throw ApiFailureException(message: data['message'] ?? "Request failed");
        }
      }
  ...
  Future<T> get<T>({
    ...
    return _request(
      request: () => dio.get(path, queryParameters: queryParams),
      fromJson: fromJson,
    );
  }
  ...
  Future<T> post<T>({
    ...
    return _request(
      request: () =>
          dio.post(path, data: inputBody, queryParameters: queryParams),
      fromJson: fromJson,
    );
  }
  ...
  Future<T> put<T>({
    ...
    return _request(
      request: () =>
          dio.put(path, data: inputBody, queryParameters: queryParams),
      fromJson: fromJson,
    );
  }
  ...
  Future<T> delete<T>({
    ...
    return _request(
      request: () =>
          dio.delete(path, data: inputBody, queryParameters: queryParams),
      fromJson: fromJson,
    );
  }
  ...
  Future<T> multipartMultifile<T>({
    ...
    return _request(
      request: () =>
          dio.post(path, data: formData, queryParameters: queryParams),
      fromJson: fromJson,
    );
  }
}
